...
Computes the skeleton of a tidal channel network.
...
def raw_skeleton(mpol):
    ...
    """Computes the center line of a tidal channel network.

    Args:
        mpol (Polygon or MultiPolygon): Tidal channel network.

    Returns:
        MultiLineStrings or list of MultiLineStrings: Raw skeleton. There is one raw skeleton MultilineStrings per tidal channel network Polygon.
    """
    ...
    # Return the raw skeleton as a MultiLineStrings or a list of
    # MultiLineStrings, depending if the tidal channel network is a Polygon or a
    # MultiPolygon.
    if len(skls) == 1:
        return skls[0]
    else:
